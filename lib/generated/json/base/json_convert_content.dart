...
class JsonConvert {
  ...
  static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
    ...
    if (<ClashConfigEntity>[] is M) {
      return data.map<ClashConfigEntity>((Map<String, dynamic> e) =>
          ClashConfigEntity.fromJson(e)).toList() as M;
    }
    if (<ClashLogEntity>[] is M) {
      return data.map<ClashLogEntity>((Map<String, dynamic> e) =>
          ClashLogEntity.fromJson(e)).toList() as M;
    }
    if (<CorpusEntity>[] is M) {
      return data.map<CorpusEntity>((Map<String, dynamic> e) =>
          CorpusEntity.fromJson(e)).toList() as M;
    }
    if (<CouponEntity>[] is M) {
      return data.map<CouponEntity>((Map<String, dynamic> e) =>
          CouponEntity.fromJson(e)).toList() as M;
    }
    if (<GuestCommConfigEntity>[] is M) {
      return data.map<GuestCommConfigEntity>((Map<String, dynamic> e) =>
          GuestCommConfigEntity.fromJson(e)).toList() as M;
    }
    if (<InviteFetchEntityEntity>[] is M) {
      return data.map<InviteFetchEntityEntity>((Map<String, dynamic> e) =>
          InviteFetchEntityEntity.fromJson(e)).toList() as M;
    }
    if (<InviteFetchEntityCodes>[] is M) {
      return data.map<InviteFetchEntityCodes>((Map<String, dynamic> e) =>
          InviteFetchEntityCodes.fromJson(e)).toList() as M;
    }
    if (<NoSubScribeEntity>[] is M) {
      return data.map<NoSubScribeEntity>((Map<String, dynamic> e) =>
          NoSubScribeEntity.fromJson(e)).toList() as M;
    }
    ...
    if (<OrderDetailPlan>[] is M) {
      return data.map<OrderDetailPlan>((Map<String, dynamic> e) =>
          OrderDetailPlan.fromJson(e)).toList() as M;
    }
    if (<PaymentEntity>[] is M) {
      return data.map<PaymentEntity>((Map<String, dynamic> e) =>
          PaymentEntity.fromJson(e)).toList() as M;
    }
    if (<PaymentMethodEntity>[] is M) {
      return data.map<PaymentMethodEntity>((Map<String, dynamic> e) =>
          PaymentMethodEntity.fromJson(e)).toList() as M;
    }
    if (<PlanEntity>[] is M) {
      return data.map<PlanEntity>((Map<String, dynamic> e) =>
          PlanEntity.fromJson(e)).toList() as M;
    }
    if (<ServerEntity>[] is M) {
      return data.map<ServerEntity>((Map<String, dynamic> e) =>
          ServerEntity.fromJson(e)).toList() as M;
    }
    if (<SubScribeEntity>[] is M) {
      return data.map<SubScribeEntity>((Map<String, dynamic> e) =>
          SubScribeEntity.fromJson(e)).toList() as M;
    }
    if (<SubScribePlan>[] is M) {
      return data.map<SubScribePlan>((Map<String, dynamic> e) =>
          SubScribePlan.fromJson(e)).toList() as M;
    }
    if (<UserCommConfigEntity>[] is M) {
      return data.map<UserCommConfigEntity>((Map<String, dynamic> e) =>
          UserCommConfigEntity.fromJson(e)).toList() as M;
    }
