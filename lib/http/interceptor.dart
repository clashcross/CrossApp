...
class ErrorInterceptor extends Interceptor {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    options.headers.addAll({
      "Authorization": SpUtil.getString('Authorization', defValue: ''),
    });
...
class HttpException implements Exception {
  ...
  factory HttpException.create(DioException error) {
    if (error.response != null) {
      ...
      return HttpException(code: statusCode, msg: error.response!.data['message']);
      ...
      switch (statusCode) {
        ...
        case 422:
          return HttpException(code: 422, msg: 'The response code 422');
        case 500:
